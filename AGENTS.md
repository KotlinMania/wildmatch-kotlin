...
This file is the quick-reference operating contract for wildmatch-kotlin. The longer
...
wildmatch-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`wildmatch`](https://crates.io/crates/wildmatch). Upstream Rust is the behavioral oracle while the
