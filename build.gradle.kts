...
kotlin {
    ...
    swiftExport {
        moduleName = "Wildmatch"
        flattenPackage = "io.github.kotlinmania.wildmatch"
    }

    android {
        namespace = "io.github.kotlinmania.wildmatch"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "wildmatch-kotlin", version.toString())

    pom {
        name.set("wildmatch-kotlin")
        description.set("Kotlin Multiplatform port of becheran/wildmatch - Simple string matching with single- and multi-character wildcard operator")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/wildmatch-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/wildmatch-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/wildmatch-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/wildmatch-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleWildmatchXCFramework",
    "assembleWildmatchDebugXCFramework",
    "assembleWildmatchReleaseXCFramework",
    "assembleDebugIosFatFrameworkForWildmatchXCFramework",
    "assembleReleaseIosFatFrameworkForWildmatchXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForWildmatchXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForWildmatchXCFramework",
    "assembleDebugMacosFatFrameworkForWildmatchXCFramework",
    "assembleReleaseMacosFatFrameworkForWildmatchXCFramework",
    "assembleDebugTvosFatFrameworkForWildmatchXCFramework",
    "assembleReleaseTvosFatFrameworkForWildmatchXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForWildmatchXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForWildmatchXCFramework",
    "assembleDebugWatchosFatFrameworkForWildmatchXCFramework",
    "assembleReleaseWatchosFatFrameworkForWildmatchXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForWildmatchXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForWildmatchXCFramework",
